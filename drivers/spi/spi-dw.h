...
#define DW_SPI_SPI_CTRLR0_SPI_RXDS_EN		BIT(18)	/* read data strobe (DQS) */
#define DW_SPI_SPI_CTRLR0_INST_DDR_EN		BIT(17)	/* instruction DDR */
#define DW_SPI_SPI_CTRLR0_SPI_DDR_EN		BIT(16)	/* addr/data DDR */
