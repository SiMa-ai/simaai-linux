...
enum OUT_FORMAT_AXI_FORMATS {
    ...
    OUT_FORMAT_AXI_FORMAT_RGB_ARGB32,
    OUT_FORMAT_AXI_FORMAT_RGB_BGRA32,
#if ( ISP_RTL_VERSION_R == 2 )
    OUT_FORMAT_AXI_FORMAT_RGB_RGBA32,
    OUT_FORMAT_AXI_FORMAT_RGB_ABGR32,
#endif
...
enum OUT_FORMAT_OUTPUT_MODES {
    ...
    OUT_FORMAT_OUTPUT_MODE_ARGB32,
    OUT_FORMAT_OUTPUT_MODE_BGRA32,
#if ( ISP_RTL_VERSION_R == 2 )
    OUT_FORMAT_OUTPUT_MODE_RGBA32,
    OUT_FORMAT_OUTPUT_MODE_ABGR32,
#endif
