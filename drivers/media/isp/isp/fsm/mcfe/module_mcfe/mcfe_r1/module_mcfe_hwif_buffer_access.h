...
static __inline uint32_t acamera_buffers_buffer_crc_read( ISP_BUFFER_T *buffer )
{
    return system_isp_read_32( (uintptr_t)&buffer->CRC ) & ACAMERA_OUT_BUFFERS_OUT_BUFFERS_BUFFER_CRC_0_FIELD_MASK;
}
