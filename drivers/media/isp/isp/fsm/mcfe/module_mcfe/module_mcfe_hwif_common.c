...
void mcfe_hwif_input_cdma_init( void )
{
    ...
    for ( i = 0; i < MODULE_MCFE_INPUT_PORT_MAX; i++ ) {
        ...
        acamera_frontend_mcfe_input_stat_valid_write( PHY_ADDR_ISP, i, 0 );
        acamera_frontend_mcfe_input_stat_base_write( PHY_ADDR_ISP, i, 0 );
        acamera_frontend_mcfe_input_stat_size_write( PHY_ADDR_ISP, i, 0 );
        acamera_frontend_mcfe_input_stat_read_units_write( PHY_ADDR_ISP, i, 0 );
    }
}
...
void mcfe_hwif_input_fifos_config_init( void )
{
    ...
    acamera_frontend_mcfe_fifo4_low_watermark_write( PHY_ADDR_ISP, 16 );
    acamera_frontend_mcfe_fifo4_high_watermark_write( PHY_ADDR_ISP, 2047 );
}
...
void mcfe_hwif_input_fifo_config( uint8_t input, uint16_t data_width, uint16_t width )
{
    switch ( input ) {
    case 0:
        acamera_frontend_mcfe_fifo1_low_watermark_write( PHY_ADDR_ISP, width * data_width / 64 );
        break;
    case 1:
        acamera_frontend_mcfe_fifo2_low_watermark_write( PHY_ADDR_ISP, width * data_width / 64 );
        break;
    case 2:
        acamera_frontend_mcfe_fifo3_low_watermark_write( PHY_ADDR_ISP, width * data_width / 64 );
        break;
    case 3:
        acamera_frontend_mcfe_fifo4_low_watermark_write( PHY_ADDR_ISP, width * data_width / 64 );
        break;
    }
}
...
{
    LOG( LOG_INFO, "isp_hwif_top_config %#x %d, %d", cdma_addr, rggb_start, cfa_pattern);
...
//#ifdef ACAMERA_ISP_TOP_CFA_PATTERN_DEFAULT
