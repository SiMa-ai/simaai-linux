...
#ifndef __ACAMERA_SFS_STREAMER_H__
#define __ACAMERA_SFS_STREAMER_H__
 ...
 * @return  0 on success
 *
 * @details This function is the SimpleFrameStorage frame streamer implementation
...
#endif // __ACAMERA_SFS_STREAMER_H__