...
#define LOG2_SENSOR_AGAIN_MAXIMUM 4 // Sensor Analog Gain: 0dB - 24dB
#define LOG2_SENSOR_DGAIN_MAXIMUM 4 // Sensor Digital Gain: 24dB to 48dB
...
#define SENSOR_TOTAL_HEIGHT 11250 // Vmax for 9fps
