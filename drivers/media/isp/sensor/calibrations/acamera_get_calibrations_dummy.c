...
extern int32_t get_calibrations_static_native_dummy( void *param );
extern int32_t get_calibrations_dynamic_native_dummy( void *param );
...
int32_t get_calibrations_dummy( uint32_t wdr_mode, void *param )
{
    ...
    case WDR_MODE_NATIVE:
        ...
        ret += ( get_calibrations_dynamic_native_dummy( param ) + get_calibrations_static_native_dummy( param ) );
        break;
    }
