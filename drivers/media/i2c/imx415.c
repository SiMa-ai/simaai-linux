...
#define IMX415_EMB_DATA           IMX415_REG_8BIT(0x3338)
#define IMX415_OB_DATA_1          IMX415_REG_8BIT(0x3038)
#define IMX415_OB_DATA_2          IMX415_REG_8BIT(0x3337)
#define IMX415_ACTIVE_LOW         IMX415_REG_8BIT(0x303A)
#define IMX415_ACTIVE_HIGH        IMX415_REG_8BIT(0x303B)
...
/* all-pixel 2-lane 594 Mbps mode */
static const struct imx415_reg imx415_mode_2_594[] = {
	{ IMX415_VMAX, 0x0C80 },
	{ IMX415_HMAX, 0x0BC4 },
	{ IMX415_LANEMODE, IMX415_LANEMODE_2 },
	{ IMX415_TCLKPOST, 0x67 },
	{ IMX415_TCLKPREPARE, 0x27 },
	{ IMX415_TCLKTRAIL, 0x27 },
	{ IMX415_TCLKZERO, 0xB7 },
	{ IMX415_THSPREPARE, 0x2F },
	{ IMX415_THSZERO, 0x4F },
	{ IMX415_THSTRAIL, 0x2F },
	{ IMX415_THSEXIT, 0x47 },
	{ IMX415_TLPX, 0x27 },
};
...
static const struct imx415_reg imx415_init_table[] = {
	...
	{ IMX415_REVERSE, 0x00 },
         ...
         /* crop settings */
        { IMX415_PIX_VST, 0x0028 },
        { IMX415_PIX_VWIDTH, 0x10E0 },
        { IMX415_PIX_HST, 0x000C },
        { IMX415_PIX_HWIDTH, 0x0F00 },
	...
	{ IMX415_DRV, 0x00 },
        ...
        /* Disable embedded and optical black data */
        { IMX415_EMB_DATA, 0x00 },
        { IMX415_OB_DATA_1, 0x00 },
        { IMX415_OB_DATA_2, 0x80 },

        { IMX415_ACTIVE_HIGH, 0x08 },
        { IMX415_ACTIVE_LOW, 0x70 },
