...
#define V4L2_CID_TEST_FPGA_BASE      (V4L2_CTRL_CLASS_USER | 0x3000)

#define V4L2_CID_FPGA_MIPI_TX_CLK_MODE	(V4L2_CID_TEST_FPGA_BASE + 0)
#define V4L2_CID_FPGA_MIPI_SPEED	(V4L2_CID_TEST_FPGA_BASE + 1)
#define V4L2_CID_FPGA_MIPI_ENABLE_DT1	(V4L2_CID_TEST_FPGA_BASE + 2)
#define V4L2_CID_FPGA_MIPI_ENABLE_DT2	(V4L2_CID_TEST_FPGA_BASE + 3)
#define V4L2_CID_FPGA_MIPI_ENABLE_DT3	(V4L2_CID_TEST_FPGA_BASE + 4)
#define V4L2_CID_FPGA_MIPI_ENABLE_DT4	(V4L2_CID_TEST_FPGA_BASE + 5)
#define V4L2_CID_FPGA_TPG_MODE		(V4L2_CID_TEST_FPGA_BASE + 6)
#define V4L2_CID_FPGA_READ_TX_STATUS	(V4L2_CID_TEST_FPGA_BASE + 7)

// FPGA TX status
#define V4L2_CID_FPGA_TX_READ_FIFO_OVERFLOW		(V4L2_CID_TEST_FPGA_BASE + 8)
#define V4L2_CID_FPGA_TX_READ_FPS		(V4L2_CID_TEST_FPGA_BASE + 9)
#define V4L2_CID_FPGA_TX_READ_LC		(V4L2_CID_TEST_FPGA_BASE + 10)
#define V4L2_CID_FPGA_TX_READ_WC		(V4L2_CID_TEST_FPGA_BASE + 11)

#define FPGA_RST_HANDLE		1
#define FPGA_FIRMWARE_UPDATE	1
#define FPGA_MAJOR_FW_VERSION	0x00001
#define FPGA_MINOR_FW_VERSION	0x00001
#define FPGA_SLAVE_ADDR		0x0D

/* Default CSI-2 link frequency (Hz) used when the device tree endpoint does
 * not provide a "link-frequencies" property.
 */
#define FPGA_DEFAULT_LINK_FREQ	1188000000ULL
 ...
 * If required any custom modes add here.
 */
...
uint8_t tx_ref_clk = 24;
uint8_t gear = 16;
uint8_t lanes = 2;

uint8_t ns_target = 150;

uint16_t tx_target_speed = 594;
bool test_pattern;

uint8_t tp_fps = 10;
uint16_t tp_width = 3840;
uint16_t tp_height = 2160;
uint8_t tx_byte_clk;
